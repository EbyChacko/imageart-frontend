...
import home from "../assets/Images/printing-home.png"
                ...
                <Row className='Align-items-center'>
                    ...
                    <div >
                        <div className="banner_para">
                            <h1 className="home-heading"><span className="bold">Printing Your Vision</span> , Perfectly Delivered!</h1>
                            <br></br>
                            ...
                            <p style={{ color: "#a9008b" }} > Visit us today and let us elevate your printing experience!</p>
                        </div>
                    </div>
                        
                    </Col>
                    <Col xs={12}  lg={5} className="d-flex justify-content-center align-items-center">
                        <img src={home} className="home_img" alt="printing-home" />
                    </Col>
                </Row>
            </Container>
        </section>
